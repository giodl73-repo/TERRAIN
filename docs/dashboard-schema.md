...
| `site` | `site_id`, `territory_id`, `territory_label`, `demand`, `revenue`, `capacity`, `overload`, `owner_count`, `assignee_count`, `assignees`, `latitude`, `longitude`, `product_*` |
| `product_balance` | `product`, `min_demand`, `max_demand`, `spread_ratio` |
