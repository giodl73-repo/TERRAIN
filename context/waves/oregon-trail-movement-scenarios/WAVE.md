...
| 03 | Exception packet | done | Combine movement, balance, compactness, and diagnostics into a review packet. |
| 04 | Field review export | done | Emit a plain-language review artifact for field managers and dashboard builders. |
